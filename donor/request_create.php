            ...
            <div class="col-lg-8">
                ...
                <div class="form-card animate-fade-up">
                    <div class="text-center mb-5">
                        ...
                        <h2 class="fw-bold text-dark">Request Blood</h2>
                        <p class="text-muted">Submit a request for blood units.</p>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="blood_group_id">Blood Group Needed</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="amount">Units Required</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <label for="hospital_name">Name of Patient/Hospital</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
